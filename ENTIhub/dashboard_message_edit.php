...
<p><input type="submit" name="draft" value="Guarda como borrador" formaction="dashboard_message_draft.php" /></p>
<p><input type="submit" name="draft" value="Actualitzar missatge" formaction="dashboard_message_update.php" /></p>
